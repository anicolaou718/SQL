...
(Select car_transferred_date From cards Where car_id = cre_car_id) As Transferred--, cre_emp_sale_type
Into #AllNotes
from notes
...
where seqnum in (1) Order by 3,10,4 --and (Invoice-Payment) > 0 Order By pro_old_id
